...
import { TrendingUp, Dumbbell, Scale, Activity, ChevronDown, Camera, ChevronLeft, ChevronRight, X, Zap, AlertTriangle } from 'lucide-react'
...
// ── Main ──────────────────────────────────────────────────
type Section = 'fuerza' | 'peso' | 'volumen' | 'adherencia' | 'records' | 'comparativa' | 'distribucion' | 'rm' | 'racha' | 'fotos' | 'pesos_sugeridos' | 'fatiga'
